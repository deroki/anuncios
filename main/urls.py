...
urlpatterns = [
    ...
    path('edit_pdi/', views.crear_pdi, name='edit_pdi'),
    path('edit_pdi/<int:pk>', views.crear_pdi, name='edit_pdi'),
    ...
    path('estadisticas/<int:pk>/', views.estadisticas, name='estadisticas'),
    #autocomplete
